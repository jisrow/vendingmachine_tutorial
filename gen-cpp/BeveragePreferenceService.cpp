    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->b = (BeverageType::type)ecast8;
          this->__isset.b = true;
        } else {
...
uint32_t BeveragePreferenceService_GetBeverage_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("b", ::apache::thrift::protocol::T_I32, 1);
...
void BeveragePreferenceServiceClient::GetBeverage(std::string& _return, const BeverageType::type b)
{
  send_GetBeverage(b);
  recv_GetBeverage(_return);
}

void BeveragePreferenceServiceClient::send_GetBeverage(const BeverageType::type b)
{
  int32_t cseqid = 0;
...
void BeveragePreferenceServiceProcessor::process_GetBeverage(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->GetBeverage(result.success, args.b);
...
void BeveragePreferenceServiceConcurrentClient::GetBeverage(std::string& _return, const BeverageType::type b)
{
  int32_t seqid = send_GetBeverage(b);
  recv_GetBeverage(_return, seqid);
}

int32_t BeveragePreferenceServiceConcurrentClient::send_GetBeverage(const BeverageType::type b)
{
