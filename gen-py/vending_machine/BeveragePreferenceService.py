...
class Client(Iface):
    ...
    def GetBeverage(self, b):
        ...
        """
        self.send_GetBeverage(b)
        return self.recv_GetBeverage()

    def send_GetBeverage(self, b):
...
class Processor(Iface, TProcessor):
    ...
    def process_GetBeverage(self, seqid, iprot, oprot):
        ...
        result = GetBeverage_result()
        try:
            result.success = self._handler.GetBeverage(args.b)
...
class GetBeverage_args(object):
    ...
    def write(self, oprot):
        ...
        if self.b is not None:
            oprot.writeFieldBegin('b', TType.I32, 1)
